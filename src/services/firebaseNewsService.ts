      ...
      const articlesList: NewsArticle[] = snapshot.docs
        ...
        .map((docSnap) => {
          ...
          return {
            ...
            authorDistrict: data.authorDistrict || undefined,
            source: data.source || '',
...
export async function addArticleToFirebase(newArt: Partial<NewsArticle>): Promise<NewsArticle> {
  ...
  const article: NewsArticle = {
    ...
    authorId: newArt.authorId || undefined,
    authorEmail: newArt.authorEmail || undefined,
    authorAvatar: newArt.authorAvatar || undefined,
    authorDistrict: newArt.authorDistrict || undefined,
